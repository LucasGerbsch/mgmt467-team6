...
As of 2025-12-13, 9:16 PM UTC the dashboard is predicting the following based of the data its been trained on:
Total Predicted Casual Trips: 57744
Total Predicted Member Trips: 412279
Predicted Total Trips: 470023

We can also see:
- the split of Predicted Casual Trips over the Next 7 Days as a bar chart indicating the number of predicted casual trips for each day
- the split of Predicted Member Trips over the Next 7 Days as a bar chart indicating the number of predicted member trips for each day
